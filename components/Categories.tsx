  ...
  return (
    <section id="categories" className="bg-background px-5 py-20 md:px-8 md:py-28">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-4 md:grid-cols-2 md:gap-5 lg:grid-cols-[1.15fr_1fr]">
  ...
  return (
    <Link
      ...
      className={`group relative block overflow-hidden rounded-md bg-soft ${
        tall ? "min-h-[420px] md:min-h-full md:h-full" : "min-h-[210px]"
      }`}
    >
      <Image
        src={category.image}
      ...
      <div className="absolute inset-x-0 bottom-0 flex items-end justify-between p-5 md:p-6">
        ...
        <span className="inline-flex items-center gap-1.5 rounded-full bg-white px-4 py-2 text-xs font-semibold tracking-wide text-foreground transition-transform duration-300 group-hover:translate-x-0.5">
          {category.cta}
