...
export function AdminShell({
  ...
  return (
    <div data-admin className="min-h-screen bg-neutral-100 text-neutral-900">
        ...
        <aside className="border-b border-neutral-200 bg-white lg:fixed lg:top-0 lg:left-0 lg:h-screen lg:w-64 lg:border-r lg:border-b-0">
          ...
          <div className="border-t border-neutral-100 px-5 py-4">
            ...
            <form action={logoutAction} className="mt-2">
              <button
                type="submit"
                className="admin-text-btn text-sm font-medium text-neutral-900 underline-offset-2 hover:underline"
              >
                Cerrar sesión
              </button>
            </form>
