...
export function WhatsAppFloat({ contact }: { contact: ContactSettings }) {
  ...
  return (
    <a
      ...
      aria-label={contact.whatsappCtaLabel}
      className="fixed right-5 bottom-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform hover:scale-105 md:right-8 md:bottom-8"
    >
